...
<br />
		<div class="container">
			<br />
			<h3>Simple PHP Mysql Shopping Cart using Cookies</h3><br />
			<br /><br />
			<?php
			$query = "SELECT * FROM addcard ORDER BY id ASC";
          ...
          <td>$ quantity = intval($quantity);</td>
          <td>$price = floatval($price);</td>
          <td>$total = $quantity * $price;</t>
